...
interface ValidatedTransactionLayer2Snapshot extends TransactionLayer2Snapshot {
    readonly maliciousContractIndex: Readonly<Record<string, TransactionLayer2MaliciousContract>>;
}
...
declare function resolveCanonicalTransactionIntel(snapshot: ValidatedTransactionLayer2Snapshot | null, lookup: CanonicalTransactionIntelLookup, trustedOriginIntel: TrustedTransactionOriginIntel): TransactionIntelContext;
